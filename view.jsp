...
<div class="content_mid">
	...
	<ul>
		<li><p class="plan telefonia"><span class="icon"></span>Telefon&iacute;a Fija 2 <span class="tipo">Nacional ilimitada</span></p>
		<p class="precio">$0000000</p>
		</li>
		<li><p class="plan internet"><span class="icon"></span>Internet <span class="tipo">15 megas</span></p>
		<p class="precio">$0000000</p>
		<li><p class="plan television"><span class="icon"></span>Plan TV <span class="tipo">Diamante</span></p>
		<p class="precio">$0000000</p>
		</li>
	...
	<form id="formSolicitud">
		<div id="divSolicitud" style="display: none;">
			...
			<div>
				...
				<input type="text" id="telefono" name="telefono" placeholder="Tel&eacute;fono" maxlength="20" />
			</div>
