...
var hideProgressInternet = {
	init: function() {
		$(".containerProgreso li:nth-child(2)").hide();
	}
}
var hideProgressTVsolo = {
	init: function() {
		$(".containerProgreso, .containerProgreso li:nth-child(1), .containerProgreso li:nth-child(2)").hide();
	}
}
var showProgressContainer = {
	init: function() {
...
$(".containerProgreso").show();
$(".containerProgreso li:first-of-type").addClass("shown");
} else {
	$("#planesInternet").hide();
// breadcrumb NOT active
...
showProgressContainer.init();
$(".containerProgreso li:nth-child(1), .containerProgreso li:nth-child(2)").addClass("shown");
} else {
	$("#planesTv").hide();
// breadcrumb NOT active
...
$("#tabs").hide();
$(".containerProgreso").show();
$(".containerProgreso li:nth-child(3)").addClass("shown");
} else {
	$("#planesTvHd").hide();
// breadcrumb NOT active
...
$(" .containerProgreso li:nth-child(4)").addClass("shown");
} else {
	$("#planesTvDecos").hide();
// breadcrumb NOT active
...
jQuery('div.planTVDeco').children('select').change(function() {
	$(" .containerProgreso li:nth-child(5),  .containerProgreso li.total").addClass("shown");
